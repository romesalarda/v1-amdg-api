...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            bases=(
                models.Model,
                apps.payments.mixins.DiscountMixin,
                apps.payments.mixins.PaymentMixin,
            ),
        ),
        migrations.CreateModel(
            name="BookingPackageRule",
            fields=[
                (
                    "rule_id",
                    models.UUIDField(
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Value associated with the rule (e.g. age limit, organisation name, etc.)",
                        max_length=255,
                        null=True,
                    ),
                ),
